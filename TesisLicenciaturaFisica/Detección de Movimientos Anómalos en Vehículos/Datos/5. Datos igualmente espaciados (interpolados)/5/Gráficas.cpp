...
char Datos_de_entrada[50] = "Datos5.5.txt";
...
char G_Datos[3][100]={"G_Datos_x_5.txt", "G_Datos_y_5.txt", "G_Datos_z_5.txt"};  //Los ejes x e y están al revés debido a que se quizo nombrar a los ejes del acelerómetro del telefono de forma diferente a la de fábrica
