...
char archivo_de_entrada[50]="Datos3_etiq.txt";
char archivo_de_salida[50]="inter.txt";

//###############################################################################################################

int Num_de_datos=(ventana/dt)+1;
...
file_0 << xyzt1[3] << ',' << xyzt1[0] << ',' << xyzt1[1] << ',' << xyzt1[2] << ' ' << a << endl;
...
Interpolar();
file_0 << xyzt_inter[3] << ',' << xyzt_inter[0] << ',' << xyzt_inter[1] << ',' << xyzt_inter[2] << ' ' << a << endl;
xyzt_inter[3]+=dt;
c1++;
}
else{
