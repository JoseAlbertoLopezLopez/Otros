...
char Datos_de_entrada[50] = "integralDatos32.txt";
...
char G_Datos[3][100]={"G_Datos_x2.txt", "G_Datos_y.txt", "G_Datos_z.txt"};  //Los ejes x e y están al revés debido a que se quizo nombrar a los ejes del acelerómetro del telefono de forma diferente a la de fábrica
