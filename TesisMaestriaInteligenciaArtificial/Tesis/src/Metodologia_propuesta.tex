...
\begin{function}[H]
	...
	\BlankLine
		...
		\eIf{$o_{ij} \not\in l$}{
			...
			\JustifiedComment*[l]{Ejecutar uno de los siguientes pares de recur\-siones:}
			...
			\Else{
				\Comment*[l]{Si en ambos pares alguna de las dos recursiones terminó con fallo:}
...
\begin{algorithm}[H]
	...
	\TwoBlankLines
	\Comment*[l]{Lista para almacenar todas las secuencias posibles para tomar un objeto.}
	$L = \{ \}$\;
	\TwoBlankLines
	\Comment*[l]{Función que retorna todas las soluciones posibles de $\f{secuencia()}$.}
	$\f{encontrarTodas}()$\;
	\TwoBlankLines
...
\begin{algorithm}[H]
	...
	\TwoBlankLines
	%
	\Comment*[l]{Parámetros del algoritmo.}
	$T = \num{50000000}$\;
	...
	\TwoBlankLines
	%
	\Comment*[l]{Puntajes actual y de intercambio.}
