...
int Ns[numClases] = {40,80};

double T = 50000000;	// 50000000
double coefT = 0.0000001;	// 0.0000001
...
while(T>(1.0*b/(1.0-a))+0.00001){	// T>(1.0*b/(1.0-a))+0.00001
	...
	else{copiarMalla(malla, mallaNew); contItInutiles++;}
...
cout << "Iteraciones inútiles finales = " << contItInutiles << endl;
