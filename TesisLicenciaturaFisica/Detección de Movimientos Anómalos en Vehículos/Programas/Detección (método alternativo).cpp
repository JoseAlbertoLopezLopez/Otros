...
/*
      ...
      cout << endl;*/
         ...
         if(salida[1][num_capas-1][2]>0.7 or salida[0][num_capas-1][2]>0.7){
            if(salida[1][num_capas-1][2]>=salida[0][num_capas-1][2]){    
            file_SxC_z << 15+(c2-1)*0.5 << ' ' << salida[1][num_capas-1][2] << endl;
            }
            else{
            file_SxC_z << 15+(c2-1)*0.5 << ' ' << salida[0][num_capas-1][2] << endl;
            }
         }
         else{
            if(salida[1][num_capas-1][2]>=salida[0][num_capas-1][2]){    
         ...
         file_C << "\"<echo '" << 15+(c2-1)*0.5 << ' ' << num_evento[2] << "\'\" w p ls 7 lc 7 t \"" << imprimir_cadena(num_evento[2],C) << "\", \\" << endl;
         }
         else if(salida[0][num_capas-1][0]<0.3 and salida[0][num_capas-1][1]>0.7 and salida[0][num_capas-1][2]<0.3 ){
         file_C << "\"<echo '" << 15+(c2-1)*0.5 << ' ' << num_evento[1] << "\'\" w p ls 7 lc 2 t \"" << imprimir_cadena(num_evento[1],C) << "\", \\" << endl;
         }
         else if(salida[0][num_capas-1][0]<0.3 and salida[0][num_capas-1][1]<0.3 and salida[0][num_capas-1][2]>0.7 ){
         file_C << "\"<echo '" << 15+(c2-1)*0.5 << ' ' << num_evento[3] << "\'\" w p ls 7 lc 1 t \"" << imprimir_cadena(num_evento[3],C) << "\", \\" << endl;
         }
         else if(salida[0][num_capas-1][0]<0.3 and salida[0][num_capas-1][1]<0.3 and salida[0][num_capas-1][2]<0.3 ){
         file_C << "\"<echo '" << 15+(c2-1)*0.5 << ' ' << num_evento[0] << "\'\" w p ls 7 lc 6 t \"" << imprimir_cadena(num_evento[0],C) << "\", \\" << endl;
         }
         else{
         file_C << "\"<echo '" << 15+(c2-1)*0.5 << ' ' << num_evento[4] << "\'\" w p ls 7 lc 6 t \"" << imprimir_cadena(num_evento[4],C) << "\", \\" << endl;
         }

         if(salida[1][num_capas-1][0]>0.7 and salida[1][num_capas-1][1]<0.3 and salida[1][num_capas-1][2]<0.3){
         file_S << "\"<echo '" << 15+(c2-1)*0.5 << ' ' << num_evento[2] << "\'\" w p ls 7 lc 7 t \"" << imprimir_cadena(num_evento[2],S) << "\", \\" << endl;
         }
         else if(salida[1][num_capas-1][0]<0.3 and salida[1][num_capas-1][1]>0.7 and salida[1][num_capas-1][2]<0.3 ){
         file_S << "\"<echo '" << 15+(c2-1)*0.5 << ' ' << num_evento[1] << "\'\" w p ls 7 lc 2 t \"" << imprimir_cadena(num_evento[1],S) << "\", \\" << endl;
         }
         else if(salida[1][num_capas-1][0]<0.3 and salida[1][num_capas-1][1]<0.3 and salida[1][num_capas-1][2]>0.7 ){
         file_S << "\"<echo '" << 15+(c2-1)*0.5 << ' ' << num_evento[3] << "\'\" w p ls 7 lc 1 t \"" << imprimir_cadena(num_evento[3],S) << "\", \\" << endl;
         }
         else if(salida[1][num_capas-1][0]<0.3 and salida[1][num_capas-1][1]<0.3 and salida[1][num_capas-1][2]<0.3 ){
         file_S << "\"<echo '" << 15+(c2-1)*0.5 << ' ' << num_evento[0] << "\'\" w p ls 7 lc 6 t \"" << imprimir_cadena(num_evento[0],S) << "\", \\" << endl;
         }
         else{
         file_S << "\"<echo '" << 15+(c2-1)*0.5 << ' ' << num_evento[4] << "\'\" w p ls 7 lc 6 t \"" << imprimir_cadena(num_evento[4],S) << "\", \\" << endl;
         }

         if(salida[1][num_capas-1][0]*salida[0][num_capas-1][0]>0.7 and salida[1][num_capas-1][1]*salida[0][num_capas-1][1]<0.3 and (salida[1][num_capas-1][2]<0.3 or salida[0][num_capas-1][2]<0.3) ){
         file_CxS << "\"<echo '" << 15+(c2-1)*0.5 << ' ' << num_evento[2] << "\'\" w p ls 7 lc 7 t \"" << imprimir_cadena(num_evento[2],CxS) << "\", \\" << endl;
         }
         else if(salida[1][num_capas-1][0]*salida[0][num_capas-1][0]<0.3 and salida[1][num_capas-1][1]*salida[0][num_capas-1][1]>0.7 and (salida[1][num_capas-1][2]<0.3 or salida[0][num_capas-1][2]<0.3) ){
         file_CxS << "\"<echo '" << 15+(c2-1)*0.5 << ' ' << num_evento[1] << "\'\" w p ls 7 lc 2 t \"" << imprimir_cadena(num_evento[1],CxS) << "\", \\" << endl;
         }
         else if(salida[1][num_capas-1][0]*salida[0][num_capas-1][0]<0.3 and salida[1][num_capas-1][1]*salida[0][num_capas-1][1]<0.3 and (salida[1][num_capas-1][2]>0.7 or salida[0][num_capas-1][2]>0.7) ){
         file_CxS << "\"<echo '" << 15+(c2-1)*0.5 << ' ' << num_evento[3] << "\'\" w p ls 7 lc 1 t \"" << imprimir_cadena(num_evento[3],CxS) << "\", \\" << endl;
         }
         else if(salida[1][num_capas-1][0]*salida[0][num_capas-1][0]<0.3 and salida[1][num_capas-1][1]*salida[0][num_capas-1][1]<0.3 and (salida[1][num_capas-1][2]<0.3 or salida[0][num_capas-1][2]<0.3) ){
         file_CxS << "\"<echo '" << 15+(c2-1)*0.5 << ' ' << num_evento[0] << "\'\" w p ls 7 lc 6 t \"" << imprimir_cadena(num_evento[0],CxS) << "\", \\" << endl;
         }
         else{
         file_CxS << "\"<echo '" << 15+(c2-1)*0.5 << ' ' << num_evento[4] << "\'\" w p ls 7 lc 6 t \"" << imprimir_cadena(num_evento[4],CxS) << "\", \\" << endl;
         }
