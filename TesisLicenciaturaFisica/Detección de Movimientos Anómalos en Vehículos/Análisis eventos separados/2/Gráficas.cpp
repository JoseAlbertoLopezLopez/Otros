...
char Datos_de_entrada[50] = "Datos2.15.txt";
...
char G_Datos[3][100]={"G_Datos_xyz_5.txt", "NULL.txt", "NULL.txt"};  //Los ejes x e y están al revés debido a que se quizo nombrar a los ejes del acelerómetro del telefono de forma diferente a la de fábrica
