...
char Datos_de_entrada[50] = "Datos6.17.txt";
...
char G_Datos[3][100]={"G_Datos_xy_7.txt", "G_Datos_xz_7.txt", "G_Datos_yz_7.txt"};  //Los ejes x e y están al revés debido a que se quizo nombrar a los ejes del acelerómetro del telefono de forma diferente a la de fábrica
