/* Este programa genera un archivo de salida que contiene las amplitudes más altas de senos y cosenos.*/
...
string cadena="Frecuencias_mas_altas_C.txt";           //Nombre del archivo de entrada.
strcpy(archivo_de_entrada, (cadena).c_str());
file_1_C.open(archivo_de_entrada);
N_de_lineas_C=N_de_lineas();

cadena="Frecuencias_mas_altas_S.txt";                  //Nombre del archivo de entrada.
strcpy(archivo_de_entrada, (cadena).c_str());
