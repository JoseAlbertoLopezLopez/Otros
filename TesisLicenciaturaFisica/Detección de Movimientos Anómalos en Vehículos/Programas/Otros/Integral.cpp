...
char archivo_de_entrada[50] = "Datos1.txt";
char archivo_de_salida[50] = "integralDatos1.txt";
...
sum_x += ((xyzt[0]-127-1.659)/25.5)*(xyzt2[3]-xyzt[3]);
sum_y += ((xyzt[1]-127)/25.5)*(xyzt2[3]-xyzt[3]);
sum_z += ((xyzt[2]-127-25.023)/25.5)*(xyzt2[3]-xyzt[3]);
