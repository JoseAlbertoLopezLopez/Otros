...
% Permitir justificación y división silábica de palabras al final de línea en comentarios.
\newcommand*\customTypewritter{%
  \itshape%
  \ttfamily%
...
\let\OldCommentSty\CommentSty
\def\beginCommentSty{}
\newcommand{\AtBeginCommentSty}[1]{\gdef\beginCommentSty{#1}}
\renewcommand{\CommentSty}[1]{\beginCommentSty\OldCommentSty{#1}}
\renewcommand{\SetCommentSty}[1]{\renewcommand{\CommentSty}[1]{\beginCommentSty\textnormal{\csname#1\endcsname{##1}}\unskip}}%

% Redefinición de símbolo de comentario y su estilo.
\def\speechBubbleComment{\fontsize{10}{10}\selectfont\faComments[regular]}
\SetKwComment{JustifiedComment}{\AtBeginCommentSty{\justifying}\speechBubbleComment\ }{\gdef\beginCommentSty{}}
\SetKwComment{Comment}{\speechBubbleComment\ }{}
\newcommand\customCommentStyle[1]{\textcolor{gray!80!black}{\customTypewritter #1}}
\SetCommentSty{customCommentStyle}
